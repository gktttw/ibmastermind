...
function gamipress_bp_member_achievements_content() {
    ...
    foreach ( $achievements_types_to_show as $achievement_type ) {
        ...
        if ( strpos( $_SERVER['REQUEST_URI'], $achievement_type ) ) {
...
function gamipress_bp_before_member_header() {
    ...
    $points_placement = gamipress_bp_get_option( 'points_placement', 'tab' );
    ...
    $achievements_placement = gamipress_bp_get_option( 'achievements_placement', 'tab' );
    ...
    $ranks_placement = gamipress_bp_get_option( 'ranks_placement', 'tab' );
