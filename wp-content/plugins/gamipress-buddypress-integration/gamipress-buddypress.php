...
final class GamiPress_BuddyPress {
     ...
     * @access      public
     * @since       1.0.0
     * @return      object self::$instance The one true GamiPress_BuddyPress
     */
    ...
    public function admin_notices() {
        ...
        <?php elseif ( is_multisite() && version_compare( GAMIPRESS_VER, '1.4.8', '<' ) ) : ?>
            ...
            <div id="message" class="notice notice-error is-dismissible">
                <p>
                    <?php printf(
                        __( 'GamiPress - BuddyPress integration requires %s or higher in order to enable multisite features. Please update your GamiPress install.', 'gamipress-buddypress-integration' ),
