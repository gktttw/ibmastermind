...
final class GamiPress_bbPress {
    ...
    private function constants() {
        // Plugin version
        define( 'GAMIPRESS_BBP_VER', '1.1.1' );
    ...
    private function includes() {
        ...
        if( $this->meets_requirements() ) {
            ...
            require_once GAMIPRESS_BBP_DIR . 'includes/content-filters.php';
    ...
    public function admin_notices() {
        ...
        <?php elseif ( is_multisite() && version_compare( GAMIPRESS_VER, '1.4.8', '<' ) ) : ?>
            ...
            <div id="message" class="notice notice-error is-dismissible">
                <p>
                    <?php printf(
                        __( 'GamiPress - bbPress integration requires %s or higher in order to enable multisite features. Please update your GamiPress install.', 'gamipress-bbpress-integration' ),
